...
public class Console {
    ...
    public Console(DisponibilitesDAO disponibilitesDAO, ListeAttenteDao attenteDAO,
                   RendezVousDAO rdvDAO, DonneeCliniqueObservableImpl observable , DonneCliniqueListeAttenteObservableImpl attenteObservable){
        ...
        AfficheCreneauxDateAction action1 = 
            new AfficheCreneauxDateAction(1,"Afficher les créneaux disponibles pour une date donnée",disponibilitesDAO, attenteDAO , attenteObservable);
        ...
        SupprimerRdvAction action4 =
            new SupprimerRdvAction(4, "Supprimer un rendez-vous",rdvDAO , attenteDAO , observable , attenteObservable);
    ...
    public void traiterAction() throws SQLException{
